...
// compute dt
double Quad::computeDt(double courant, const ABC &abc, std::ofstream &outData, int tagNum) const {
    // get vp
    ...
    // Added by Axel 
    /* Move this out so have access within whole funciton. Commented out 
    this in the "if else" below*/
